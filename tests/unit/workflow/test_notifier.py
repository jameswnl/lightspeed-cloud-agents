...
from cloud_agents.workflow.notifiers.notifier import NullNotifier, SlackNotifier, WebhookNotifier
...
class TestSlackNotifier:
    ...
    async def test_sends_payload(self) -> None:
        ...
        with patch("cloud_agents.workflow.notifiers.notifier.httpx.AsyncClient") as mock_client_cls:
