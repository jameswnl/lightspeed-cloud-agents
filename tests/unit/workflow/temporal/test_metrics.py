...
class TestMetricsExist:
    ...
    def test_workflow_runs_total_counter(self) -> None:
        ...
        from cloud_agents.workflow.executor.temporal.metrics import ls_workflow_runs_total
    ...
    def test_step_runs_total_counter(self) -> None:
        ...
        from cloud_agents.workflow.executor.temporal.metrics import ls_workflow_step_runs_total
