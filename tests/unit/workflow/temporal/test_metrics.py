...
class TestMetricsExist:
    ...
    def test_workflow_runs_total_counter(self) -> None:
        ...
        from cloud_agents.workflow.executor.temporal_metrics import ls_workflow_runs_total
    ...
    def test_workflow_run_duration_histogram(self) -> None:
        ...
        from cloud_agents.workflow.executor.temporal_metrics import ls_workflow_run_duration_seconds
    ...
    def test_step_runs_total_counter(self) -> None:
        ...
        from cloud_agents.workflow.executor.temporal_metrics import ls_workflow_step_runs_total
    ...
    def test_step_duration_histogram(self) -> None:
        ...
        from cloud_agents.workflow.executor.temporal_metrics import ls_workflow_step_duration_seconds
