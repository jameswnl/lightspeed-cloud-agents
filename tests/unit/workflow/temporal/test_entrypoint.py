...
class TestTemporalEntrypoint:
    ...
    def test_tracing_initialized_on_build(self, mocker: MockerFixture) -> None:
        ...
        mock_init = mocker.patch(
            "cloud_agents.workflow.executor.temporal.entrypoint.init_tracing",
        )
    ...
    def test_tls_config_read_from_env(self, mocker: MockerFixture) -> None:
        ...
        from cloud_agents.workflow.executor.temporal.entrypoint import _build_tls_config
    ...
    def test_worker_has_tracing_interceptor(self) -> None:
        ...
        from cloud_agents.workflow.executor.temporal.entrypoint import _get_tracing_interceptors
...
class TestTranscriptStoreWiring:
    ...
    def test_transcript_store_created_when_env_set(
        ...
        mock_store_cls = mocker.patch(
            "cloud_agents.workflow.executor.temporal.entrypoint.TranscriptStore",
        )
    ...
    def test_transcript_store_passed_to_router(
        ...
        mock_router_fn = mocker.patch(
            "cloud_agents.workflow.executor.temporal.entrypoint.build_temporal_router",
        )
